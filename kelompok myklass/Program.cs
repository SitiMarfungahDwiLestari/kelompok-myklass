...
namespace kelompok_myklass
{
    internal class Program
    {
                                                ...
                                                case '2':
                                                    {
                                                        ...
                                                        try
                                                        {
                                                            pr.insert(id_makanan, nm_makanan, jenis_makanan, harga, keterangan, conn);
                                                        }
                                                        catch
                                                        {
        ...
        public void insert(string id_makanan, string nm_makanan, string jenis_makanan, string harga, string keterangan, SqlConnection con)
        {
            string str = "";
